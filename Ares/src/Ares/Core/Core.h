...
// platform detection using predefined macros
    ...
    */
        ...
        #define ARES_PLATFORM_IOS
        #error "IOS is not supported!"
    #elif TARGET_OS_MAC == 1
        #define ARES_PLATFORM_MACOS
...
*/
    ...
    #define ARES_PLATFORM_ANDROID
    #error "Android is not supported!"
#elif defined(__linux__)
    #define ARES_PLATFORM_LINUX
...
#define ARES_BIND_EVENT_FN(fn) [this](auto&&... args) -> decltype(auto) { return this->fn(std::forward<decltype(args)>(args)...); }
namespace Ares 
{
    template<typename T>
