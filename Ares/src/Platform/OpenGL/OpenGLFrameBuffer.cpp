...
namespace Ares
{
	...
	void OpenGLFrameBuffer::Bind() const
	{
		...
		//ARES_CORE_LOG("Frame Buffer ID Bind {0}", this->m_RendererID);
			});
	}
	...
	void OpenGLFrameBuffer::Resize(uint32_t width, uint32_t height, bool force)
	{
		...
		//ARES_CORE_LOG("Frame Buffer ID before {0}", this->m_RendererID);
		...
		//ARES_CORE_LOG("Frame Buffer ID after {0}", this->m_RendererID);
